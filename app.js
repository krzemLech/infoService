...
const config = require('./config') || null; // plik z konfiguracją aplikacji

// połączenie i kontrola połączenia w mongoose
mongoose.connect(process.env.MONGODB_URI || config.db, { useNewUrlParser: true, useUnifiedTopology: true })
...
app.use(function (req, res, next) { // potrzebne do generowania klasy active w navbarze
